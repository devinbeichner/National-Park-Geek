...
public class FormViewTest {
	...
	@Test
	public void test_survey_link() {

		WebElement surveyLink = webDriver.findElement(By.linkText("Survey"));
		surveyLink.click();
		assertTrue(webDriver.getTitle().contentEquals("NPGeek Favorite Park Survey"));

	}

	@Test
	public void test_page_loads_properly() {
	...
	@Test
	public void test_form_can_be_submitted() {
		...
		assertTrue(webDriver.getTitle().contentEquals("NPGeek Favorite Parks"));
